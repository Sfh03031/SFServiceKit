...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SparkeXHApp/SFServiceKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SparkeXHApp' => 'sfhery@foxmail.com' }
  s.source           = { :git => 'https://github.com/SparkeXHApp/SFServiceKit.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'SFServiceKit' => ['SFServiceKit/Assets/*.png']
  # }
